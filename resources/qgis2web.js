...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:2193',
            //extent: [1787979.000000, 5752906.606200, 1792346.060700, 5755593.815600],
            units: 'm'
        })
    })
});
...
map.getView().fit([1787083.509812, 5750466.624462, 1792295.289812, 5758399.019179], map.getSize());
